...
// books-outlet-firebase-adminsdk.json
...
const uri =`mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.yezku.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
